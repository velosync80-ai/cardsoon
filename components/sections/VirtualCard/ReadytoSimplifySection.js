  ...
  return (
    <section className="py-10 md:py-20  bg-gradient-to-br from-emerald-600 to-teal-700 text-white">
      <div className="max-w-7xl mx-auto  rounded-0 md:rounded-3xl">
        <div className="max-w-7xl mx-auto grid md:grid-cols-1 gap-11 items-center px-5 py-10 md:pt-0">
          <div className="flex flex-col text-center gap-5">
            <h3 className="text-white font-bold text-4xl md:text-5xl font-SFProBold">Ready to Go Global?</h3>
