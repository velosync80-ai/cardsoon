...
const faqs = [
  ...
  },
  {
    ...
    a: "You can fund your virtual card by adding money to your Cardsoon wallet by trading gift cards."
  },
  {
  ...
  },
  {
    ...
    a: "The card creation fee is $1, which will be deducted from your Cardsoon balance, plus a top-up fee of 1.5%. For other fees, please refer to the Terms and Conditions page. Exchange rates may vary based on market conditions."
  },
  {
...
export default function FaqSection() {
  ...
  return (
    <section className="py-16 bg-[#F9FAFB]">
      ...
      <div className="max-w-4xl mx-auto space-y-6 pt-5 px-4 md:px-0">
        {faqs.map((item, idx) => (
          <div
            key={item.q}
